...
5) Compose: Using only information and wording present in {context}, produce the answer to the user question {question} in the psychologist's style. The answer must: - Begin with one short validating sentence (3–12 words). - Use 2–4 of the extracted characteristic phrases (incorporated naturally). - Include one of the listed metaphors or examples. - Be 120–220 words long. - Preserve a balance of professional and accessible language. - Not add any new facts beyond {context}. If {context} lacks information required to answer, output exactly: "Данный вопрос не содержится в моей базе знаний." At the end, append a 1-sentence note (in Russian) that states which quoted phrase(s) from step 1 were used in the answer, e.g., "Used phrases: «…», «…»."
"""
